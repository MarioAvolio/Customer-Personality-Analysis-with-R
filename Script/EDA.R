...
dataSet <- mutate(dataSet, Education = case_when(Education == 1 ~ "graduate",
                                                     Education == 0 ~ "non-graduate" ))
dataSet <- mutate(dataSet, Marital_Status = case_when(Marital_Status == 1 ~ "Couple",
...
#--------------------------- Age
#Age pie plot
ggplot(dataSet, aes(x="", fill=ageRange))+
  geom_bar(width = 1)+
...
ggplot(data=dataSet) +
  ...
  ggtitle('Histogram of age of dataSet')
...
#--------------------------- Education
# Education Level
ggplot(dataSet, mapping=aes(x=Education, fill=Education)) + 
  geom_bar() + 
...
#--------------------------- Marital Status
df_temp = dataSet %>% count(Marital_Status) %>% filter(n>5)
...
ggplot(dataSet, aes(x="", fill=incomeRange))+
  geom_bar(width = 1)+
  coord_polar("y")+theme_void()
...
mplot = ggplot(dataSet, aes(x=Marital_Status,y=Income,fill=Marital_Status))+ylim(0,180000)+geom_boxplot(outlier.colour="black")
mplot

eduplot = ggplot(dataSet, aes(x=Education,y=Income,fill=Education))+ylim(0,180000)+geom_boxplot(outlier.colour="black")
eduplot
#--------------------------- 


#--------------------------- Spent pie plot
ggplot(dataSet, aes(x="", fill=spentRange))+
  geom_bar(width = 1)+
  coord_polar("y")+theme_void()
...
ggplot(dataSet, aes(x=Total_Childs)) + geom_histogram(binwidth = 0.5, colour = "Black")
#NOTE:
...
#--------------------------- Age
age_childs_histogram <- ggplot(dataSet, aes(x=Total_Childs)) + geom_histogram(aes(fill=Age_range), binwidth = 0.5, colour = "Black")
...
#--------------------------- Marital_Status
marital_status_childs_histogram <- ggplot(dataSet, aes(x=Total_Childs)) + geom_histogram(aes(fill=Marital_Status), binwidth = 0.5, colour = "Black")
...
education_childs_histogram <- ggplot(dataSet, aes(x=Total_Childs)) + geom_histogram(aes(fill=Education), binwidth = 0.5, colour = "Black") 
...
#--------------------------- Income
income_childs_plot <- ggplot(dataSet, aes(y=Income, x=Total_Childs)) + geom_jitter() 
income_childs_plot + ylim(0, 100000)

income_childs_histogram <- ggplot(dataSet, aes(x=Total_Childs)) + geom_histogram(aes(fill=Income_range), binwidth = 0.5, colour = "Black") 
...
ggplot(dataSet, aes(x=Age, y=Total_Childs, colour=Marital_Status, size=Income)) + 
...
#--------------------------- Age
age_total_spent_histogram <- ggplot(dataSet, aes(x=Total_spent)) + facet_grid(Age_range~.) 
...
#--------------------------- Marital_Status
marital_status_total_spent_histogram <- ggplot(dataSet, aes(x=Total_spent)) + facet_grid(Marital_Status~.) 
...
#--------------------------- Education
education_total_spent_histogram <- ggplot(dataSet, aes(x=Total_spent)) + facet_grid(Education~.)
...
#--------------------------- Children
education_total_spent_histogram <- ggplot(dataSet, aes(x=Total_spent)) + facet_grid(Total_Childs~.)
...
#--------------------------- Income
income_total_spent_histogram <- ggplot(dataSet, aes(x=Total_spent)) + geom_histogram(aes(fill=Income_range), binwidth = 15, colour = "Black")
income_total_spent_histogram + facet_grid(Income_range~.)
ggplot(dataSet, aes(y=Income, x=Total_spent)) + geom_jitter() + geom_smooth()

#--------------------------- 

ggplot(dataSet, aes(x=Total_spent, y=Income, colour=Marital_Status, size=Income)) + 
  facet_grid(Marital_Status~Education) + 
  geom_jitter() + ylim(0,100000) + geom_smooth() + geom_boxplot(size=0.7, alpha=0.5)


ggplot(dataSet, aes(x=Total_spent, y=Income, colour=Total_Childs, size=Income)) + 
  facet_grid(Total_Childs~Education) + 
  geom_jitter() + ylim(0,100000) + geom_smooth() + geom_boxplot(size=0.7, alpha=0.5)


ggplot(dataSet, aes(x=Total_spent, y=Income, colour=Age_range, size=Income)) + 
...
#                                                                      #
########################################################################
ggplot(dataSet, aes(x=Total_Campains)) + geom_histogram(binwidth = 0.5, colour = "Black") + xlab("Number of different Campain")
...
dataAcceptedCmp <- data.frame(
  ...
  value = c(sum(dataSet$AcceptedCmp1), sum(dataSet$AcceptedCmp2), sum(dataSet$AcceptedCmp3),
           sum(dataSet$AcceptedCmp4), sum(dataSet$AcceptedCmp5))
)
...
#--------------------------- Age
ggplot(dataSet, aes(x=Total_Campains)) + geom_histogram(aes(fill=Age_range), binwidth = 0.5, colour = "Black") + facet_grid(Age_range~.) + xlab("Number of campaign accepted ")
...
#--------------------------- Marital_Status (X)
ggplot(dataSet, aes(x=Total_Campains)) + geom_histogram(aes(fill=Marital_Status), binwidth = 0.5, colour = "Black") + facet_grid(Marital_Status~.) + xlab("Number of campaign accepted")
...
#--------------------------- Total_Childs
ggplot(dataSet, aes(x=Total_Campains)) + geom_histogram(aes(fill=Total_Childs), binwidth = 0.5, colour = "Black") + facet_grid(Total_Childs~.) + xlab("Number of campaign accepted")
...
#--------------------------- Education (X)
ggplot(dataSet, aes(x=Total_Campains)) + geom_histogram(aes(fill=Education), binwidth = 0.5, colour = "Black") + facet_grid(Education~.) + xlab("Number of campaign accepted")
#--------------------------- 


#--------------------------- Income
ggplot(dataSet, aes(x=Total_Campains)) + geom_histogram(aes(fill=Income_range), binwidth = 0.5, colour = "Black") + facet_grid(Income_range~.) + xlab("Number of campaign accepted")
...
# DataExplorer::create_report(dataSet, output_dir = paste(getwd(),"/Output/Data/",sep = ""), output_file = "reportAfterDataPreprocessing.html")
########################################################################
...
#                                                                      #
########################################################################
dataSet <- select(dataSet, -Age_range)
dataSet <- select(dataSet, -Income_range)
########################################################################
